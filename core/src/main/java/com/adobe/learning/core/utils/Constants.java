...
public class Constants {
  ...
  public static final class Config {
    ...
    public static final String LEARNER_TOKEN_URL =
        "/oauth/o/learnerToken?learner_email={email}&min_validity_sec={min_validity_sec}";
    ...
    public static final String ALM_CONFIGURATION_NAME =
        "cloudconfigs/adobe-learning-manager-config";
    public static final String ALM_SUB_CONFIG_PATH =
        "/" + CLOUD_CONFIG_SETTINGS + "/" + ALM_CONFIGURATION_NAME + "/" + JcrConstants.JCR_CONTENT;
    private static final Map<String, String> MUTABLE_NAVIGATION_PATHS =
    ...
    public static final Map<String, String> NAVIGATION_PATHS =
        Collections.unmodifiableMap(MUTABLE_NAVIGATION_PATHS);
  }
  ...
  public static final class CPUrl {
    ...
    public static final String WIDGET_SRC_URL =
        "{hostName}/app/embeddablewidget?widgetRef={widgetRef}&resourceType=html";
    public static final String WIDGET_COMMUNICATOR_URL =
        "{hostName}/app/embeddablewidget?widgetRef=com.adobe.captivateprime.widgetcommunicator";
  }
}
