// //import { GetStore, APIWidgetStore, JsonApiDataRef } from "./APIStore";
// import { JsonApiResponse } from "../models/models";
// import { IRestAdapterGetOptions, RestAdapter } from "./RestAdapter";

// export function JsonApiParse(jsonApiResponse: any, storeType: WidgetType): JsonApiResponse {
...
//                     }
//                 } else retval = ObjectWrapper.GetWrapper(relData["type"], relData["id"], this.storeToUse_lxpv);
//             }
//         }
//         return retval;
//     }
