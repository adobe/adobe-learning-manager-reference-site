...
const SocialLearningPage = () => {
  ...
  const infoClickHandler = () =>{
    const new_window= window.open("https://helpx.adobe.com/learning-manager/learners/feature-summary/social-learning-web-user.html","_BLANK");
    new_window?.open();
  }
  return (
    <>
    { <Grid areas={[
        ...
        <View gridArea="header" UNSAFE_className={styles.bannerbg}>
          <div className={styles.bannerbg} >
            ...
            <h1 className={styles.socialLearningHeading}>{formatMessage({id:"alm.social.socialLearning" , defaultMessage:"Social Learning"})}</h1>
            <h4 className={styles.socialLearningMoto}>{formatMessage({id:"alm.social.socialLearningMotto" , defaultMessage:"Where learning becomes social.  Learn anywhere and share it here with your peers."})}</h4>
            <button className={styles.infoButton} onClick={infoClickHandler}>{formatMessage({id:"alm.social.text.knowMore" , defaultMessage:"Know More"})}</button>
            </div>
          </div>
        </View>
